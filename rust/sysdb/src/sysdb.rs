...
impl GrpcSysDb {
    ...
    pub async fn get_collection_to_gc(
        ...
        let database_name = DatabaseName::new(&collection.database);
    ...
    async fn mark_version_for_deletion(
        ...
        let database_name_str = database_name.as_ref().map(|d| d.as_ref().to_string());
        ...
        let res = match database_name {
            ...
            None => self.client.mark_version_for_deletion(req).await?,
        };
